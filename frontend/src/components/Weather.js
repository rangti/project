...
default:
  ...
  return (
    <div className="light" style={{ maxWidth: '16rem', marginTop:-5}}>
      {getWeatherIcon()}
      <p style={{color:'#ffffff'}}> {jsonItem[2]} &nbsp; {jsonItem[3]} ℃ </p>
    </div>
  );
}
    ...
    const fetchData = async () => {
      try {
        ...
        if (data.response.header.resultCode === '00') {
          ...
          if (pty === '0') {
            if (sky === '1') jsonItem[2] = '맑음';
            else if (sky === '3') jsonItem[2] = '구름많음';
            else if (sky === '4') jsonItem[2] = '흐림';
          } else if (pty === '1') jsonItem[2] = '비';
          else if (pty === '2') jsonItem[2] = '비/눈';
          else if (pty === '3') jsonItem[2] = '눈';
          else if (pty === '5') jsonItem[2] = '빗방울';
          else if (pty === '6') jsonItem[2] = '빗방울눈날림';
          else if (pty === '7') jsonItem[2] = '눈날림';

          console.log(jsonItem); // 로그에 처리된 데이터 출력
      ...
      <h5>
        {weatherData &&
          ...
          weatherData.response.body.items.item && (
            <WeatherCard
              jsonItem={jsonItem} // 배열 jsonItem 전달
            />
          )}
      </h5>
      {!weatherData && <p>😉</p>}
