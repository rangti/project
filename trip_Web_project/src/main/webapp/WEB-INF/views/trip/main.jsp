						...
						<c:choose>
							<c:when test="${empty trip.trip_images}"> 
								<img class="trip-images"
									src="https://lh3.googleusercontent.com/oucDcDAOVG1fLnm_XdisT0Sp3c72sI8JuR_PWKWmeXBn5_rNadTd7pW3FXuGQrOz8zHwhlhX2OYCPGBzfHNR_X8LWg=s1280-w1280-h800"
									alt="${trip.trip_title}" />
							</c:when>
							<c:otherwise>
								<img class="trip-images" src="${trip.trip_images}"
									alt="${trip.trip_title}" />
							</c:otherwise>
						</c:choose>
						<p>${trip.trip_addr}</p>
