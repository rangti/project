...
def grape():
    ...
    # 월별 합계 데이터 생성
    quarterly_sum = df[['abroad']].apply(lambda x: number_handling(x), axis=1).resample('Q').sum()
    ...
    total_list = quarterly_sum['abroad']
    ...
    #json_1 = to_json2(df)
    return render_template('graph_date.html'
